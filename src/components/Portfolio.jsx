...
const ProjectCard = ({ index, name, description, image, videoUrl }) => {
  ...
  return (
    ...
    >
      <div className="relative w-full md:w-3/5">
        {videoUrl ? (
          <div className="relative w-full aspect-[16/7] md:aspect-[16/6] lg:aspect-[16/5] min-h-[350px] md:min-h-[450px] lg:min-h-[500px]">
            <iframe
              src={videoUrl}
              title={name}
          ...
          <div className="relative w-full aspect-[16/7] md:aspect-[16/6] lg:aspect-[16/5] min-h-[350px] md:min-h-[500px] lg:min-h-[650px]">
            <img
              src={image}
              alt="project_image"
